...
-   💯 **Worth**:
    ...
    -   **Implementation**: 25%
-   📅 **Due**:
    -   **Proposal**: April 25/26, 2024 @ 11:30
...
3. **Entity Relationships:**
    ...
    - If you're curious as to how I did the one in the sample proposal, I use [Mermaid](https://mermaid.js.org) to write out my diagrams in plaintext which get automatically rendered. This allows my diagrams to be version controlled using Git! Check out the docs [here](https://mermaid.js.org/syntax/entityRelationshipDiagram.html) and live editor [here](https://mermaid.live).
...
5. **Wireframes:**
    ...
    - The wireframes in the sample proposal were made using [Excalidraw](https://excalidraw.com/). [Here's a nice short tutorial](https://www.youtube.com/watch?v=O1Kqxw07VWM) which Vik made.

![Excalidraw](../../../assets/project/excalidraw.png)
...
| 👀 **Views**                          | Handlebars templates are well-organized, and dynamic content is integrated seamlessly. The UI is responsive and visually appealing. Thought was clearly put into the design and user experience.   | Templates are functional and data is rendered correctly. UI has a basic usable structure, while not necessarily responsive.                    | Templates have errors in data display or lack essential dynamic elements. UI is difficult to navigate or has layout issues.     | Templates are incomplete or broken, preventing core functionality. UI is unusable.                                    |
...
3. Ensure that the web app folders are at the root of the repo directory. In other words, I don't want to see an `App-Template` folder in the final submission.
